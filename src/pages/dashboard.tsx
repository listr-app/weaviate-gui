...
const teams = [
  { id: 1, name: "Example1", href: "#", initial: "H", current: false },
  { id: 2, name: "Example2", href: "#", initial: "T", current: false },
  { id: 3, name: "Example3", href: "#", initial: "W", current: false },
];
      ...
      */}
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-green-600 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">Weaviate GUI</div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                  <ul role="list" className="-mx-2 space-y-1">
